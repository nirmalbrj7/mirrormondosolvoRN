...
const FormList=(props)=>{
    ...
    const formRef = firestore().collection(`forms_${orgSlug}`)
    .where('userIds', 'array-contains', currentUid && 'draftUsers', 'array-contains', currentUid)
   // .where('draftUsers', 'array-contains', currentUid)
    ;
