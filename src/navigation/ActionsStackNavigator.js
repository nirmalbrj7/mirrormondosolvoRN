...
import ListRecord from  '../pages/Datagrid/listRecord';
import AddRecord from  '../pages/Datagrid/addRecord';
...
<Stack.Screen
        ...
        options={{headerTitle: 'ListRecord'}}
