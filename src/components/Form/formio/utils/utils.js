...
//  alert("ccc"+JSON.stringify(instance));
console.log("com"+component.customConditional);
  if (typeof custom === 'string') {
    custom = `var ${variable} = true; ${custom}; return ${variable};`;
    console.log("com2"+custom);
  }
  const value = (instance && instance.evaluate) ?
   ...
   // alert("checkCustomConditional"+JSON.stringify(value));
  if (value === null) {
    return onError;
  }
  if(value=='true'){
  ...
  console.log("com3"+value);
  console.log("com4"+value==false?'false':'true');
  return value;
}
