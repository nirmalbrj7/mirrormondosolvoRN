...
function defineTransformerOutsideStrictMode() {
  const safeGlobalName = '____formioSelectMixinGetTransformer';
...
const getTransformer = defineTransformerOutsideStrictMode();
...
export const interpolate = (template, variables) => {
  const transform = getTransformer(variables);
