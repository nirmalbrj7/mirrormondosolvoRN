      ...
      datagridSchema.map((val,index)=>{
        if(val.key==parentkey){
         ...
         //val.number==component.state.value.item
            ...
            if (mainDatagrid && mainDatagrid.length > 0) {

              console.log("heree2");
              mainDatagrid.map((val2, index) => {
                   console.log("heree3");
                   console.log(cardId);
                   console.log(val.id);
                   var newindex = 0;
                   if (cardId == val2.id) {
                     ...
                     console.log("heree4");
                    // console.log(mainDatagrid[index]);
                     mainDatagrid[index][currentkey] = component.state.value.item;
     
                    // this.data[parentkey][0][childkey] = currentArray;
                   }
...
<Text>currentPageSubmissionData{JSON.stringify(currentPageSubmissionData)}</Text>
<Text> this.state{JSON.stringify( this.state)}</Text>
