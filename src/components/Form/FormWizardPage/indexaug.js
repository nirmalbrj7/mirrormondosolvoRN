...
class FormWizardPage extends React.PureComponent {
  constructor(props) {
    ...
    if (props.currentPageSubmissionData) {
      ...
      //alert("cloned"+JSON.stringify(this.data));
    } else {
      this.data = {};
    }

    //this.data={"textField1":"5","textField2":"6"};
  ...
  checkCalculative = (component) => {
    ...
    if (component.hasOwnProperty("calculateValue")) {
      ...
      console.log("show2" + JSON.stringify(show));
      this.data[key] = show;
      this.data[key] = show;
      return this.data;
...
console.log("/////////////////////////////");
console.log("/////////////////////////////");
console.log("CHANGE 6"+JSON.stringify(component.props.component.key));
console.log("/////////////////////////////");
console.log("/////////////////////////////");
console.log("/////////////////////////////");
//console.log("bbbbbb"+JSON.stringify(component));
console.log("a"+JSON.stringify(this.data));
    ...
    if (currentComponent.hasOwnProperty('datagridItem')) {
     ...
     console.log("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
      ...
      console.log("DATAGRID AAYO"+JSON.stringify(currentArray));
      console.log("datagridId"+JSON.stringify(datagridId));
      console.log("datagridItem"+JSON.stringify(datagridItem));
      console.log("datagridIndex"+JSON.stringify(datagridItem));
      console.log("currentkey"+JSON.stringify(currentkey));
      console.log("parentkey"+JSON.stringify(parentkey));
      ...
      datagridSchema.map((val,index)=>{
        if(val.key==parentkey){
         ...
         //val.number==component.state.value.item
            ...
            console.log('GRAND PARENT'+JSON.stringify(grandParent));
         //   alert("dddgrandPARENET"+JSON.stringify(this.data[grandParent]));
           // if(this.data[grandParent][0].length==0){
             // alert("dddgrandPARENET"+JSON.stringify(this.data[grandParent][0][parentkey]));
              var mainDatagrid=this.data[grandParent][0][parentkey];
              console.log('mainDatagrid'+JSON.stringify(mainDatagrid));
...
"template": "<span>{{ item.id_hogar }}<\/span>",
"selectThreshold": 0.3,
...
"customConditional": "show = (data.a_gen_categ8a==1) && (data.a_gen_filtro1 !== '') && (data.a_gen_filtro2 !== '') && (data.a_gen_filtro4 !== '') && (data.a_gen_filtro5 !== '') && (data.a_gen_filtro8 !== '') && (data.a_gen_filtro8a !== '') && (data.a_gen_filtro11 !== '') && (data.a_gen_filtro12 !== '') && (data.a_gen_filtro13 !== '') && (data.a_gen_filtro9 !== '');",
"overlay": {
  "style": null,
  "left": null,
  "top": null,
...
"tableView": false,
"key": "page4",
"customConditional": "show = (data.a_gen_inf_11=='ocupantes_survey') || (data.a_gen_inf_11=='[ocupantes_survey, construccion_survey]');",
"type": "panel",
"label": "INFORMACI\u00d3N DE LOS OCUPANTES",
"input": false,
"components": [{
...
"tableView": false,
"key": "page5",
"customConditional": "show = (data.a_gen_inf_11 == 'construccion_survey') || (data.a_gen_inf_11=='ocupantes_survey construccion_survey');",
"type": "panel",
"label": "INFORMACI\u00d3N DE LA VIVIENDA",
"input": false,
"components": [{
...
"values": [{
  ...
  "label": " dise\u00f1o y presupuesto de la vivienda",
  "value": "disenoYPresupuestoDeLaVivienda",
  "shortcut": ""
}, {
  "label": "NINGUNA",
  "value": "ninguna",
...
"customConditional": "show = data.global !== null;",
"type": "htmlelement",
"input": false
}, {
"label": "id_descuento",
...
"label": "count_redes_intradomiciliarias_bis",
"mask": false,
"spellcheck": true,
"tableView": false,
"delimiter": false,
...
"key": "count_redes_intradomiciliarias_bis",
"type": "number",
"input": true
}, {
...
"values": [{
  ...
  "value": "salaComedorPasillos",
  "shortcut": ""
}, {
  "label": "Muros divisorios internos, Alcoba",
  "value": "murosDivisoriosInternosAlcoba",
  "shortcut": ""
}, {
  "label": "Patio",
  "value": "patio",
...
"key": "area_espacio",
"customConditional": "IF(OR(espacios_choice=='cocina',espacios_choice=='lavado',espacios_choice=='bano',espacios_choice=='sala_comedor',espacios_choice=='alcoba',espacios_choice=='patio',espacios_choice=='techo_cubierta'))\r\n\r\nshow = data.espacios_choice == 'cocina' || data.espacios_choice == 'lavado' || data.espacios_choice == 'bano' || data.espacios_choice == 'sala_comedor' || data.espacios_choice == 'alcoba' || data.espacios_choice == 'patio' || data.espacios_choice == 'techo_cubierta';",
"type": "number",
"input": true
}, {
...
"key": "area_fachada",
"customConditional": "show = data.espacios_choice == 'fachada';",
"type": "number",
"input": true
}, {
...
"disabled": true,
"tableView": true,
"calculateValue": "value = data.a_bldg_dis_arq_esp1;",
"validate": {
  "required": true
},
"key": "espacios_choice",
...
"key": "3611TuberiaDeAguaPotableElEspacioPresentaTuberiaDeAguaPotableEnBuenEstadoSinEscapesNiRiesgoAContaminantes",
"type": "radio",
"input": true
}, {
"label": "HTML",
...
"tableView": false,
"key": "sec3_6_1_1_1",
"customConditional": "show = data.a_bldg_dis_viv_0a == 'si' && data.a_bldg_dis_arq_esp1z == 'nc';",
"type": "htmlelement",
"input": false
}, {
...
"key": "a_bldg_dis_arq_esp_med_1_6_2a",
"type": "number",
"input": true
}, {
"label": "HTML",
...
"content": "<h5 class=\"bg-info text-white\">\n  En caso necesite incluir unos PRECIOS UNITARIOS adicionales, por favor ingrese a este m\u00f3dulo.\n  <\/h5>",
"refreshOnChange": false,
"tableView": false,
...
"disabled": true,
"tableView": true,
"calculateValue": "if(data._3611_seleccione_apu == 'OTHER')\r\n{\r\n  value = 1;\r\n}\r\nelse\r\n{\r\n  value = 0;\r\n}",
"validate": {
  "required": true
},
...
"tableView": false,
"key": "sec3_6_1_2",
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Cocina' || data.a_bldg_dis_arq_esp1=='Zona de lavado' || data.a_bldg_dis_arq_esp1=='Ba\u00f1o';",
"type": "htmlelement",
"input": false
}, {
...
"key": "3612LavaderoLavaplatosLavamanosElEspacioCuentaConUnaZonaDeLavadoConAguaPotableYSifonParaAguasNegras",
"type": "radio",
"input": true
}, {
"label": "HTML",
...
"tableView": false,
"key": "sec3_6_1_2_1",
"customConditional": "show = data.a_bldg_dis_viv_0a=='si' || data.a_bldg_dis_arq_esp2z=='nc';",
"type": "htmlelement",
"input": false
}, {
...
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Zona de lavado';",
"type": "number",
"input": true
}, {
...
"key": "precioUnitarioAdicionalASeleccionar",
"type": "select",
"indexeddb": {
  "filter": []
},
...
"disabled": true,
"tableView": true,
"calculateValue": "if(data._3612_seleccione_apu == \"OTHER\"){\r\n  value == 1;\r\n}\r\nelse{\r\n  value === 0 ;\r\n}",
"validate": {
  "required": true
},
...
"customConditional": "show == data._3612_hasother_calc == 1;",
"type": "number",
"input": true
}, {
"label": "Ingresar cantidad",
...
"tableView": false,
"key": "sec3_6_1_3_1",
"customConditional": "show == data.a_bldg_dis_viv_0a=='si' && data.a_bldg_dis_arq_esp3z=='nc';",
"type": "htmlelement",
"input": false
}, {
...
"disabled": true,
"tableView": true,
"calculateValue": "IF(HASOTHER($3613_seleccione_apu),1,0)\r\nif(data._3613_seleccione_apu == \"OTHER\"){\r\n  value == 1;\r\n}\r\nelse{\r\n  value === 0;\r\n}",
"validate": {
  "required": true
},
...
"tableView": false,
"key": "sec3_6_1_4_1",
"customConditional": "show == data.a_bldg_dis_viv_0a=='si'&& data.a_bldg_dis_arq_esp4z=='nc'",
"type": "htmlelement",
"input": false
}, {
"label": "Demolici\u00f3n baldosa de piso (incluye guarda-escoba y retiro de sobrantes) [m2]",
...
"key": "precioUnitarioAdicionalASeleccionar3",
"type": "select",
"indexeddb": {
  "filter": []
},
...
"key": "precioUnitarioAdicionalASeleccionar4",
"type": "select",
"indexeddb": {
  "filter": []
},
...
"content": "<h5 class=\"bg-info text-white\">>>>>> ***36113 - MUEBLES COCINA***<\/h5>",
"refreshOnChange": false,
"tableView": false,
"key": "sec3_6_1_13",
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Cocina';",
...
"content": "<h5 class=\"bg-info text-white\">>>>>> ***36114 - MESON***<\/h5>",
"refreshOnChange": false,
"tableView": false,
"key": "sec3_6_1_14",
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Cocina';",
...
"content": "<h5 class=\"bg-info text-white\">>>>>> ***36115 - ESTUFA***<\/h5>",
"refreshOnChange": false,
"tableView": false,
"key": "sec3_6_1_15",
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Cocina';",
...
"content": "<h5 class=\"bg-info text-white\">>>>>> ***36126 - CONSTRUCCI\u00d3N DE PISOS***<\/h5>",
"refreshOnChange": false,
"tableView": false,
"key": "sec3_6_1_26",
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Alcoba' || data.a_bldg_dis_arq_esp1=='Ba\u00f1o' || data.a_bldg_dis_arq_esp1=='Cocina' || data.a_bldg_dis_arq_esp1=='Patio' || data.a_bldg_dis_arq_esp1=='Sala\/Comedor\/Pasillos' || data.a_bldg_dis_arq_esp1=='Zona de lavado';",
"type": "htmlelement",
"input": false
}, {
...
"content": "<h5 class=\"bg-info text-white\">>>>>> ***36117 - ACABADO PISOS***<\/h5>",
"refreshOnChange": false,
"tableView": false,
"key": "sec3_6_1_17",
"customConditional": "show = data.a_bldg_dis_arq_esp1=='Alcoba' || data.a_bldg_dis_arq_esp1=='Ba\u00f1o' || data.a_bldg_dis_arq_esp1=='Cocina' || data.a_bldg_dis_arq_esp1=='Patio' || data.a_bldg_dis_arq_esp1=='Sala\/Comedor\/Pasillos' || data.a_bldg_dis_arq_esp1=='Zona de lavado';",
...
"key": "cierreFotosGeneralesDeLaVivienda3",
"type": "file",
"url": "mondasolvo.net\/fileUpload",
"input": true
}]
    ...
    //  const aaa={"textField1":"5","textField2":"6"};
    return (
    ...
    <Text>this.state{JSON.stringify(this.props.sub)}</Text>
        ...
        <FormioComponentsList
         ...
         /* values={{
            ...
            "aaa":"aaa",
            "uploadFile": [{
              "id": 0.9541520251244825,
              "name": "4e02d682-6bbf-4877-87b9-42454650a211",
              "url": "gs://formbuilder-e5062.appspot.com/form/4e02d682-6bbf-4877-87b9-42454650a211",
              "uploading": false,
              "progress": 80,
              "firebaseDocId": "RffMQXPQfzGcA0x2ZMUU"
            }]
          }} */
